...
public:
    ...
    n(n_in)
    {
        ...
        pub_depth_feature = n.advertise<sensor_msgs::PointCloud2>("/depth/depth_feature", 5);
        pub_depth_image =   n.advertise<sensor_msgs::Image>      ("/depth/depth_image",   5);
        pub_depth_cloud =   n.advertise<sensor_msgs::PointCloud2>("/depth/depth_cloud",   5);
                                          ...
                                          const vector<geometry_msgs::Point32>& features_2d)
    {
        ...
        try{
            listener.waitForTransform("world", "body_ros", stamp_cur, ros::Duration(0.01));
            listener.lookupTransform("world", "body_ros", stamp_cur, transform);
        } 
	...
	{	*depth_cloud_local = *depthCloud;}
        ...
        *depth_cloud_local = *depth_cloud_local_filter2;
        publishCloud(&pub_depth_cloud, depth_cloud_local, stamp_cur, "body_ros");
